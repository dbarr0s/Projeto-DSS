...
(Cartao, EstadoTurno, HEntrada, HSaida, TipoFunc, Posto) 
VALUES
    (1, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'GASOLINA'),
    (2, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'ELETRICO'),
    (3, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'GERENTE', 'GERENCIA'),
    (4, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'GASOLEO'),
    (5, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'GERENTE', 'GERENCIA'),
    (6, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'UNIVERSAL'),
    (7, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'HIBRIDO'),
    (8, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'GERENTE', 'GERENCIA'),
    (9, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'GASOLEO'),
	(10, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'HIBRIDO'),
    (11, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'UNIVERSAL'),
	(12, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'ELETRICO'),
    (13, 'INICIADO', DATE_ADD(CURDATE(), INTERVAL 8 HOUR), DATE_ADD(CURDATE(), INTERVAL 17 HOUR), 'MECANICO', 'GASOLINA');
